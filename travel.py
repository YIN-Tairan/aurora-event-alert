...
# Step 4: 搜索航班并找到最低价选项
def search_cheapest_flight(token,origin, destination, departure_date, days=3, max_days=7):
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Step 3: 搜索最低价航班
        result = search_cheapest_flight(token, origin, destination, departure_date)
        print("\n最低价航班信息:")
